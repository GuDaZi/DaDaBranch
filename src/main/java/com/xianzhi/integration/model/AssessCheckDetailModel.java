...
public class AssessCheckDetailModel extends BaseHttpAsyncModel<AssessCheckDetailBean> {

    public AssessCheckDetailModel(int model_id, Context context, ModelCompleteCallback<BaseResponesBean> callback) {
    ...
    private BaseResponesBean getDatas() {
        String url = BaseApplication.url + "/integrationPreAssessment/myAssessmentDetail?month=" + holder.getDate() + "&token=" +BaseApplication.token;
