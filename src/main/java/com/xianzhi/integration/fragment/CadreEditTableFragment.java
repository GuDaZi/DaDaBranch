...
import com.xianzhi.integration.activity.ApproveDepartActivity;
import com.xianzhi.integration.activity.EnteringActivity;
...
public class CadreEditTableFragment extends Fragment implements LoweHominidsAdapter.OnLowehomindsClickListener, SuperiorLeadershipAdapter.OnSuperScoreClickListener, ModelCompleteCallback<BaseResponesBean>, OnPopupClickListener, View.OnClickListener {
    ...
    public CadreEditTableFragment(String type, String itemId) {
        this.type = type;
        this.itemId = itemId;
    }
    ...
    protected void initView() {
        ...
        vto.addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
            ...
            public boolean onPreDraw() {
                width = tv_assessType.getMeasuredWidth();
                return true;
            }
        });
    ...
    protected void setListener() {
        ...
        tv_superiorLeadership.setOnClickListener(this);
        tv_loweHominids.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.tv_save:
                if (type.equals("3")) {
                    ...
                    if (!TextUtils.isEmpty(et_approvePersonal_content.getText().toString())) {
                        Intent intent1 = new Intent(getActivity(), ApproveDepartActivity.class);
                        ...
                        ToastUtil.showShort(getActivity(), "请填写考核人意见！");
                    }
                } else {
                    ToastUtil.showShort(getActivity(), "请填写领导审批！");
                }
                break;
            ...
            case R.id.tv_assessType:
                if (isEnter3) {
                    gratePopup = new GratePopup(width, this, tableBean.getLevelList(), context);
    ...
    private void setleaderApprove() {
        model = ModelFactory.getModel(ModelFactory.LEADERAPPROVE, getActivity(), this);
    ...
    private void setUpdateDatas() {
        ...
        model = ModelFactory.getModel(ModelFactory.UPDATETABLE, getActivity(), this);
        ...
        if (result.getInterface_status() == StatusUtil.INTERFACE_OK) {
            ...
            switch (taskid) {
                case ModelFactory.CADRETABLE:
                    tableBean = FastJsonUtil.getObject(result.getDataholder().toString(), TableBean.class);
