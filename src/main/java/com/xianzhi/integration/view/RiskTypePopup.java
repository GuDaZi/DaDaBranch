...
import com.xianzhi.integration.adapter.RiskTypeAdapter;
...
public class RiskTypePopup extends PopupWindow implements RiskTypeAdapter.OnRiskClickListener{

    private RiskTypeAdapter adapter;
    private OnPopupClickListener listener;

    public RiskTypePopup(int width, OnPopupClickListener listener, List<EnterWorkBean.RiskTypesBean> datas, Context context) {
        super(context);
        ...
        adapter = new RiskTypeAdapter(this, context, datas);
