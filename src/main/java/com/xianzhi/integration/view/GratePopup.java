...
import com.xianzhi.integration.adapter.GrateAdapter;
 ...
 * @Administrator LiBo.
 * @Date 2017/7/26.
 * @Function 等级popupwindow
 */

public class GratePopup extends PopupWindow implements GrateAdapter.OnGrateClickListener {

    private GrateAdapter adapter;
    private OnPopupClickListener listener;

    public GratePopup(int width, OnPopupClickListener listener, List<TableBean.LevelListBean> datas, Context context) {
        super(context);
        ...
        adapter = new GrateAdapter(this, context, datas);
    ...
    @Override
    public void onGrateClick(String content, int pid) {
