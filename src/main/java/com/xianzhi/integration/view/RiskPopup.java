...
import com.xianzhi.integration.adapter.RiskAdapter;
 ...
 * @Administrator LiBo.
 * @Date 2017/7/17.
 * @Function 录入工作其他的popupwindow
 */

public class RiskPopup extends PopupWindow implements RiskAdapter.OnRiskClickListener{

    private RiskAdapter adapter;
    private OnPopupClickListener listener;

    public RiskPopup(int width, OnPopupClickListener listener, List<AddressTypeBean.ListBean> datas, Context context) {
        super(context);
        ...
        adapter = new RiskAdapter(this, context, datas);
