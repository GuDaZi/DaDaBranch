...
public class AddressTypePopup extends PopupWindow implements AddressTypeAdapter.OnAddressTypeClickListener{

    private AddressTypeAdapter adapter;
    private OnPopupClickListener listener;

    public AddressTypePopup(int width, OnPopupClickListener listener, List<AddressTypeBean.ListBean> datas, Context context) {
        super(context);
