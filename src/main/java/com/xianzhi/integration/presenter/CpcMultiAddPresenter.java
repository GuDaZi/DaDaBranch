...
public class CpcMultiAddPresenter extends BaseHttpAsyncModel<BaseResponesBean> {

    private static final String TAG = "SFragHD";
    private List<NameValuePair> params = new ArrayList<>();

    public CpcMultiAddPresenter(int model_id, Context context, ModelCompleteCallback<BaseResponesBean> callback, List<NameValuePair> params) {
...
//        http://223.100.3.171:10007/integrationPreAssessment/doSetPostAssessment
        String url = BaseApplication.url + "/integrationPreAssessment/doSetPostAssessment?token=" + BaseApplication.token;
