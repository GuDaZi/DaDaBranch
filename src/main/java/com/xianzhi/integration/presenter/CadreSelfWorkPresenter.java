...
public class CadreSelfWorkPresenter extends BaseHttpAsyncModel<BaseResponesBean> {

    public CadreSelfWorkPresenter(int model_id, Context context, ModelCompleteCallback<BaseResponesBean> callback) {
