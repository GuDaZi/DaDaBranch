...
public class CadrePreCheckPresenter extends BaseHttpAsyncModel<BaseResponesBean> {

    public CadrePreCheckPresenter(int model_id, Context context, ModelCompleteCallback<BaseResponesBean> callback) {
