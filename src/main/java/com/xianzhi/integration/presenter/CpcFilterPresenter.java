...
public class CpcFilterPresenter extends BaseHttpAsyncModel<BaseResponesBean> {

    private List<NameValuePair> params = new ArrayList<>();

    public CpcFilterPresenter(int model_id, Context context, ModelCompleteCallback<BaseResponesBean> callback, List<NameValuePair> params) {
...
//        String url = BaseApplication.url + "/integrationPreAssessment/list?token=" + BaseApplication.token;
        String url = BaseApplication.url + "/integrationPreAssessment/list?token=" + BaseApplication.token;
