...
public class CpcReusePresenter extends BaseHttpAsyncModel<BaseResponesBean> {
    private static final String TAG = "SFragHD";
    private List<NameValuePair> params = new ArrayList<>();

    public CpcReusePresenter(int model_id, Context context, ModelCompleteCallback<BaseResponesBean> callback, List<NameValuePair> params) {
    ...
    private BaseResponesBean getDatas() {
        //http://223.100.3.171:10007/integrationPreAssessment/doCopy
        String url = BaseApplication.url + "/integrationPreAssessment/doCopy?token=" + BaseApplication.token;
