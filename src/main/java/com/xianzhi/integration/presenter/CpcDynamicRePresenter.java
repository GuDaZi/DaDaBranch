...
public class CpcDynamicRePresenter extends BaseHttpAsyncModel<BaseResponesBean> {
    private static final String TAG = "SFragHD";
    private List<NameValuePair> params = new ArrayList<>();

    public CpcDynamicRePresenter(int model_id, Context context, ModelCompleteCallback<BaseResponesBean> callback, List<NameValuePair> params) {
    ...
    private BaseResponesBean getDatas() {
        //http://223.100.3.171:10007/integrationPreAssessment/addDynamic
        String url = BaseApplication.url + "/integrationPreAssessment/addDynamic?token=" + BaseApplication.token;
