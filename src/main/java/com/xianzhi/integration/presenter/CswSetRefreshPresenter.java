...
public class CswSetRefreshPresenter extends BaseHttpAsyncModel<BaseResponesBean> {

//    private List<String> params = new ArrayList<>();
    private String id = "";
    private String month = "";

    public CswSetRefreshPresenter(int model_id, Context context, ModelCompleteCallback<BaseResponesBean> callback, List<String> params) {
...
//        http://223.100.3.171:10007/integrationSelfRealistic/setSelfRealistic/219416?month=2017-08
        String url = BaseApplication.url + "/integrationSelfRealistic/setSelfRealistic/+"+id+"?month="+ month +"&token=" + BaseApplication.token;
