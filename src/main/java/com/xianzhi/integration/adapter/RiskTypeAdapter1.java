...
public class RiskTypeAdapter1  extends MyBaseAdapter<MyAssessWorkBean.RiskTypesBean> {

    private OnRiskClickListener listener;

    public RiskTypeAdapter1(OnRiskClickListener listener, Context context, List datas) {
        super(context, datas);
