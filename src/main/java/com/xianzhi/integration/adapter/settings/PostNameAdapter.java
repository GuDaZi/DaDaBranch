...
public class PostNameAdapter extends BaseAdapter {
    ...
    private List<CpcMultiBean.PostListBean> data = new ArrayList<>();

    public PostNameAdapter(Context context) {
        this.context = context;
    }

    public void addData(List<CpcMultiBean.PostListBean> data) {
        this.data.clear();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tvPostName.setText(data.get(position).getName());
        return view;
    }
