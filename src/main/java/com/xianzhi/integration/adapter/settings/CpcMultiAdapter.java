...
public class CpcMultiAdapter extends BaseAdapter {

    private static final String TAG = "SFragHD";
    private List<CpcMultiBean.ListBean> data = new ArrayList<>();
    ...
    public CpcMultiAdapter(Activity activity) {
        this.activity = activity;
    }

    public void addData(List<CpcMultiBean.ListBean> data) {
        this.data.clear();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            view = View.inflate(activity, R.layout.item_cpc_multi, null);
