...
public class ApproveNameAdapter extends MyBaseAdapter<ApproveDepartBean.ListBean> {

    private OnNameClickListener listener;

    public ApproveNameAdapter(OnNameClickListener listener, Context context, List datas) {
        super(context, datas);
    ...
    public View getViewDatas(final int position, View convertView, ViewGroup parent) {
        ...
        holderView.tv_content.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                listener.onNameClick(datas.get(position).getName(), datas.get(position).getId());
            }
        });
    ...
    public interface OnNameClickListener {
        void onNameClick(String content, int pid);
    }
}
