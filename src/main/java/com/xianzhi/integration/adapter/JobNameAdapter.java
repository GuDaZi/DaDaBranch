...
public class JobNameAdapter extends MyBaseAdapter<RiskControllerBean.PositionListBean> {


    private OnRiskClickListener listener;

    public JobNameAdapter(OnRiskClickListener listener, Context context, List<RiskControllerBean.PositionListBean> datas) {
        super(context, datas);
